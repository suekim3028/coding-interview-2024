...
def try1():
    # 2024-02-09 02:06:24.087597
    # 2024-02-09 02:11:44.225334

    inp = input()
    length = len(inp)/2

    score = list(map(int, inp))

    first = score[:int(length)]
    second = score[int(length):]

    # print(first)
    print("LUCKY" if sum(first) == sum(second) else "READY" )
